...
<body>
    ...
    <main>
        ...
        <form action="<?= $_SERVER["PHP_SELF"] ?>" method="get">
            ...
            <input type="number" name="p1" id="p1" step="0.01" min="1" required value="<?= $peso1 ?>">
            <label for="v2">2º Valor</label>
            <input type="number" name="v2" id="v2" step="0.01" required value="<?= $valor2 ?>">
            <label for="p2">2º Peso</label>
            <input type="number" name="p2" id="p2" step="0.01" min="1" required value="<?= $peso2 ?>">
    ...
    <section>
        ...
        <?php 
            ...
            echo "<ul>
                ...
                <li>A <strong>Média Aritmética Ponderada</strong> com pesos <strong>$peso1</strong> e <strong>$peso2</strong> é igual a " . number_format($mp, 2, ",", ".") . "</li>
            </ul>";
        ?>
    </section>
</body>
